...
export async function initializeDatabase() {
	await pool.query(`
		...
		-- Store password length for UX (safe to expose; avoids hardcoding on frontend)
		ALTER TABLE settings ADD COLUMN IF NOT EXISTS person_view_password_length INT;
